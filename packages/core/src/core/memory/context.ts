...
export class ContextManager {
  ...
  async buildContext(conversationId: string, store: MemoryStore): Promise<ChatMessage[]> {
  ...
  private selectMessages(messages: StoredMessage[], availableTokens: number): ChatMessage[] {
