...
import { MarvisAgent } from "../../src/core/marvis";
import type { PluginManager } from "../../src/plugins/manager";
import type { MemoryStore } from "../../src/core/memory/store";
...
describe("MarvisAgent", () => {
  ...
  it("should prompt and persist messages", async () => {
    ...
    expect(mockMemoryStore.addMessage).toHaveBeenCalledWith("conv-123", {
      role: "user",
      content: "Hello",
    });
  });
